    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromSize(
            bounds: Rect.fromLTWH(83.0, 787.0, 52.0, 16.0),
            size: Size(375.0, 812.0),
            pinBottom: true,
            fixedWidth: true,
            fixedHeight: true,
...
const String _svg_w304mf =
    '<svg viewBox="92.8 756.7 33.0 27.0" ><path transform="translate(91.3, 752.16)" d="M 31.5 4.5 L 4.5 4.5 C 2.849999904632568 4.5 1.5 5.849999904632568 1.5 7.5 L 1.5 25.5 C 1.5 27.14999961853027 2.849999904632568 28.5 4.5 28.5 L 12 28.5 L 12 31.5 L 24 31.5 L 24 28.5 L 31.5 28.5 C 33.15000152587891 28.5 34.48500061035156 27.14999961853027 34.48500061035156 25.5 L 34.5 7.5 C 34.5 5.849999904632568 33.15000152587891 4.5 31.5 4.5 Z M 31.5 25.5 L 4.5 25.5 L 4.5 7.5 L 31.5 7.5 L 31.5 25.5 Z" fill="#8bc6c0" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
